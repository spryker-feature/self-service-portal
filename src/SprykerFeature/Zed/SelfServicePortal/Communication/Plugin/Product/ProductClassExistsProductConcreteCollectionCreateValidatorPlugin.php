 ...
 */
class ProductClassExistsProductConcreteCollectionCreateValidatorPlugin extends AbstractPlugin implements ProductConcreteCollectionCreateValidatorPluginInterface
{
    /**
     * {@inheritDoc}
