...
class UnattachedSspAssetAttachmentTable extends AbstractTable
{
    /**
     * @var string
     */
     ...
     * @var string
     */
    protected const TABLE_IDENTIFIER = 'unattached-ssp-asset-table';
    ...
    protected function configure(TableConfiguration $config): TableConfiguration
    {
        ...
        $config->setTableAttributes([
            'data-selectable' => [
                ...
                'inputSelector' => '#fileAttachment_sspAssetIdsToBeAttached',
