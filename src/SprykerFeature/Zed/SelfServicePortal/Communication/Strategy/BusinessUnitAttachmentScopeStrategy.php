...
class BusinessUnitAttachmentScopeStrategy implements AttachmentScopeStrategyInterface
{
    /**
     * @var string
     */
     ...
     * @var string
     */
    protected const SCOPE_TYPE_BUSINESS_UNIT = 'business-unit';
    ...
    {
        return static::SCOPE_TYPE_BUSINESS_UNIT;
    }
