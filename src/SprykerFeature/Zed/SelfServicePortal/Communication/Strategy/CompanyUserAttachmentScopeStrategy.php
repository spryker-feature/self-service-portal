...
class CompanyUserAttachmentScopeStrategy extends BusinessUnitAttachmentScopeStrategy
{
    /**
     * @var string
     */
    protected const SCOPE_TYPE_COMPANY_USER = 'company-user';

    public function getScopeType(): string
    {
        return static::SCOPE_TYPE_COMPANY_USER;
    }
