...
class SspServiceChangeScheduledTimeLinkWidgetCacheKeyGeneratorStrategyPlugin extends AbstractPlugin implements WidgetCacheKeyGeneratorStrategyPluginInterface
{
    /**
     * {@inheritDoc}
     * - Generates cache key for `SspServiceChangeScheduledTimeLinkWidget`.
     *
     * @api
     *
    ...
    {
        return SspServiceChangeScheduledTimeLinkWidget::class;
    }
}
